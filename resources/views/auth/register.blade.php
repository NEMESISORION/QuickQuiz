...
>
    <form method="POST" action="{{ route('register') }}" class="flex flex-col gap-5">
        ...
        <x-ui.input label="Password" name="password" type="password" autocomplete="new-password" required revealable aria-describedby="password-guidance" />
        ...
        <x-ui.input label="Confirm password" name="password_confirmation" type="password" autocomplete="new-password" required revealable />
